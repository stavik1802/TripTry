# Common Data Schema for TripPlanner Agents
"""
Standardized data structures and schemas used across all agents.
This ensures consistency in data flow and prevents value update issues.
"""
