"""
Intercity Fare Tool for TripPlanner Multi-Agent System

This tool discovers and calculates transportation costs between cities,
including flights, trains, buses, and other intercity transportation options.
It provides comprehensive fare information for multi-city trip planning.

Key features:
- Intercity transportation cost discovery using web search
- Multi-modal options (flights, trains, buses, ferries)
- Duration parsing and travel time estimation
- Parallel processing for multiple city pairs and transportation modes
- Robust duration parsing with multiple format support

The tool enables accurate intercity transportation cost estimates,
essential for multi-city trip planning and budget optimization.
"""
