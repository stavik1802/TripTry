"""
City Recommender Tool for TripPlanner Multi-Agent System

This tool recommends cities and destinations based on user preferences, travel style,
and trip duration. It uses AI-powered analysis to suggest optimal city combinations
for multi-city trips.

Key features:
- AI-powered city recommendation based on user preferences
- Multi-city trip optimization considering travel pace
- Travel style analysis (slow, normal, fast)
- Country-based city discovery and recommendation
- Duration-aware city selection and sequencing

The tool helps users discover optimal destinations and create well-balanced
multi-city itineraries that match their travel preferences and time constraints.
"""
