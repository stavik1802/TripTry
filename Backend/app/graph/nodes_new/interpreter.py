# agent_interpreter.py — v5
# One-call LLM Interpreter that classifies intent and picks ONLY the first 6 tools.
# Duration-aware: does not require exact dates if a relative length is present.
